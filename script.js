...
function createOptions() {
  const passwordLength = parseInt(
    prompt(
      "How many characters would you like your password to contain?(you must choose more than 8 characters or less than 100!)"
    )
  );
  if (passwordLength < 8) {
  ...
  const confirmHigher = confirm(
    "Click OK to confirm including  uppercase characters "
  );
  const confirmCharacters = confirm(
